...
function Slider({
  ...
  return (
    ...
    >
      ...
      />
      <div
        className="pointer-events-none absolute size-4 shrink-0 rounded-full border border-primary/60 bg-white shadow-[0_0_8px_rgba(255,51,0,0.25)] transition-all duration-200 ease-out"
