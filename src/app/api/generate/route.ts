...
3. No fabricated specificity. Don't invent details I haven't given you — no "tomorrow", "last quarter", "as we discussed", no statistics, percentages, dollar figures, or headcounts not in my inputs, and no other detail I didn't supply. If an input says "missed target," write "missed target" — not a specific percentage. Specificity comes from my inputs only.
4. Compress. Each line earns its place. Cut hedge clauses, redundant qualifiers, and connective tissue. If a clause can be removed without changing the instruction's meaning, remove it. Trust the assistant — it doesn't need over-explanation.
5. Format for scan. The rep glances at this before pasting. Use bullets where they sharpen. Reserve prose for MISSION (where rep voice needs flow). Avoid wall-of-text paragraphs in STRUCTURE and GROUNDING.
